...
## S2: Create ALB Basic Manually
### S2-01: Create EC2 Instance with Userdata
...
## S2-03: Create Application Load Balancer
...
## S3: Copy all files from previous section 
- We are going to copy all files from previous section `TF_PROJECT_V8-ELB-Classic-LoadBalancer`
...
## S4: ALB-application-loadbalancer.tf
...
module "alb" {
  ...
  target_groups = [
    # App1 Target Group - TG Index = 0
    {
      ...
      targets = {
        my_app1_vm1 = {
          target_id = module.ec2_private["app_vm1"].id
          port      = 80
        },
        my_app1_vm2 = {
          target_id = module.ec2_private["app_vm2"].id
          port      = 80
        }
      }
...
```
## S5: ALB-application-loadbalancer-outputs.tf
```t
