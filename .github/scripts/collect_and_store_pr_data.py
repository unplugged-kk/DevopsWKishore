...
def send_to_slack(pr_title, pr_author, pr_merged_at, pr_url, pr_commit_hash, webhook_url):
    message = {
        "blocks": [
            {
                "type": "section",
...
send_to_slack(pr_title, pr_author, pr_merged_at, pr_url, pr_commit_hash, slack_webhook_url)